...
MAKE_FUNC32(adama, ADAMA, float, fp32)
MAKE_FUNC32(adama, ADAMA, half, fp16)
MAKE_FUNC32(adama, ADAMA, __nv_bfloat16, bf16)
...
MAKE_FUNC8(adama, ADAMA, float, 32)
MAKE_FUNC8(adama, ADAMA, half, 16)
...
MAKE_BLOCKWISE8(adama, ADAMA, half, fp16)
MAKE_BLOCKWISE8(adama, ADAMA, float, fp32)
...
MAKE_BLOCKWISE8(adama, ADAMA, __nv_bfloat16, bf16)
...
extern "C"
{
  ...
  void cdequantize_blockwise_fp32_nf4(float *code, unsigned char *A, float *absmax, float *out, int blocksize, const int n){ dequantizeBlockwise_fp32_nf4(code, A, absmax, out, blocksize, n); }
	...
	MAKE_CFUNC32(adama, float, fp32)
	MAKE_CFUNC32(adama, half, fp16)
	MAKE_CFUNC32(adama, __nv_bfloat16, bf16)
  ...
  {  \
	...
	MAKE_CFUNC8(adama, float, 32)
	MAKE_CFUNC8(adama, half, 16)
  ...
  {	fname##_8bit_blockwise_grad_##gbits(p, g, state1, state2, beta1, beta2, eps, step, lr, quantiles1, quantiles2, absmax1, absmax2, weight_decay, gnorm_scale, skip_zeros, n); } \
	...
	MAKE_CBLOCKWISE8(adama, ADAMA, half, fp16)
	MAKE_CBLOCKWISE8(adama, ADAMA, float, fp32)
	...
	MAKE_CBLOCKWISE8(adama, ADAMA, __nv_bfloat16, bf16)
